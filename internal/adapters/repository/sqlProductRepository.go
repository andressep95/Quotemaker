...
SELECT id, name, category_id, length, price, weight, code
FROM product
ORDER BY id
LIMIT $1 OFFSET $2;
`
...
INSERT INTO product (name, category_id, length, price, weight, code)
VALUES ($1, $2, $3, $4, $5, $6)
RETURNING id, name, category_id, length, price, weight, code;
`
